...
mainJob = new lpGeneratorService({
    interface: {
        mailSelector: '#mail_text',
        telefoneSelector: '#tel_text'
    },
    yandex: {
        yandexCounter: window.yaCounter33144723,
        yandexTrigger: true
    },
    forms: {
        toLoadPopUpButtons: ['#block-new158'],
        formWithLoadFile: ['#block-new319', '#block-new162'],
        popUpFormSubmit: '#block-new311',
        //downloadSpecial: ,
        formFromOverlayByMouseScroll: '#block-new314'
    },
    overlay: {
        byButtons: {
            elements: [
